...
TASK_LABEL = "tracking_shuffled"


def parse_args():
    parser = argparse.ArgumentParser(description="Trace tracking_shuffled with finite choice candidates.")
    ...
    parser.add_argument("--output_dir", default=f"{DEFAULT_OUTPUT_DIR}/tracking_shuffled_trace")
