...
DEFAULT_CONFIG = {
    "base_model": "/root/autodl-tmp/models/Mistral-7B-Instruct-v0.3",
    "dataset_path": "./datasets/gomoku_cot_train.json",
    "output_dir": "./checkpoints/mistral7b-gomoku-cot-maxlora",
    "cache_dir": "./cache",
    "max_length": 1024,
    "seed": 42,
    "lora": {
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Mistral-7B-Instruct on Gomoku CoT with QLoRA MaxLoRA config.")
...
def setup_environment(args):
    print("=" * 72)
    print("Mistral Gomoku CoT MaxLoRA training")
